...
repos that are gone. It needs **no enrollment token** — enrolling the machine already
authorized the SSH access the rescan reuses:
...
The index page exposes the same action as a one-click **Rescan a machine** control.
